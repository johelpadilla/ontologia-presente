...
\begin{importantbox}
La intensificación local del presente (Capa 1) genera efectos estructurales (Capa 3) con mayor probabilidad cuando los módulos presentan escalas de persistencia más coherentes entre sí (baja antisincronización, Capa 2). De lo contrario, la intensificación permanece como un fragmento aislado que el sistema puede absorber sin reorganizarse. Este efecto de filtrado probabilístico en dirección ascendente se denomina, entre comillas, «resistencia ascendente».
\end{importantbox}
