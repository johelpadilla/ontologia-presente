...
**⚠️ VERSIÓN DE TRABAJO v0.1.1-mejoras-ontologicas — EDITAR SOLO AQUÍ**

Esta carpeta es una **versión de trabajo** creada por copia limpia de `versions/v0.1.0-frozen/` (junio 2026).  
Contiene el manuscrito mejorado con precisiones ontológicas y terminológicas (definición estricta de «resistencia» como efecto estructural de filtrado probabilístico, capas más rigurosas y explícitamente no reductibles, subsección completa de objeciones, eliminación de frase de versión, correcciones técnicas).
...
**Estado de esta versión**: 14 páginas, compilación limpia (0 errores LaTeX, 0 Overfull críticos), TOC y Referencias completos, sin la frase "Primera versión formal para publicación (junio 2026)", con mejoras de rigor y honestidad académica detalladas en CHANGELOG.md de esta carpeta.
...
**Importante**: Para citación oficial use siempre la versión congelada (`v0.1.0-frozen`). Esta `v0.1.1-mejoras-ontologicas` es una versión de trabajo interna con refinamientos ontológicos.

**Formato APA (esta versión de trabajo):**

Padilla-Villanueva, J. (2026). *Hacia una ontología del presente en sistemas complejos: RECD, persistencia intensificada y la dinámica de la fragmentación* (v0.1.1-mejoras-ontologicas, working copy with ontological refinements). Ubicación: `versions/v0.1.1-mejoras-ontologicas/` del repositorio.
...
@article{padilla_ontologia_presente_2026,
  ...
  version = {0.1.1-mejoras-ontologicas}
}
```
...
**Nota de versión de trabajo (v0.1.1-mejoras-ontologicas)**

Esta carpeta implementa las mejoras solicitadas como editor académico senior en sistemas complejos y ontología de procesos:
- Definición estricta de «resistencia» (efecto estructural de filtrado probabilístico, sin antropomorfismo).
- Mayor rigor en las definiciones de las tres capas + explicitación de no reductibilidad.
- Respuestas honestas a 5 objeciones en Discusión.
- Eliminación de la frase de «Primera versión formal...».
- Correcciones técnicas (overflows/bib, paquetes, 14 páginas con TOC + Referencias limpios).
- Consistencia terminológica en todo el documento.
- Documentación (CHANGELOG + este README) dentro de la carpeta.

La política de versiones se respeta estrictamente: solo se edita dentro de subcarpetas nuevas; la congelada `v0.1.0-frozen/` permanece inmutable.

*Compilado final: 14 páginas, junio 2026. Ver CHANGELOG.md para el registro detallado de cambios.*
