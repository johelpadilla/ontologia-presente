...
La dinámica entre capas puede visualizarse, de forma heurística y limitada, mediante la analogía de un huracán maduro. Las intensificaciones locales (celdas convectivas intensas) corresponden a presentes locales intensificados, mientras que la organización entre escalas (bandas, eyewall, circulación general) corresponde a la reducción de fragmentación y al aumento de coherencia entre presentes locales. La inercia del huracán maduro ilustra el efecto de filtrado probabilístico de las capas superiores frente a intensificaciones locales fragmentadas; la desorganización (cizalladura, interacción con tierra) corresponde al aumento de antisincronización.

La analogía resulta útil para ilustrar que la intensificación local no se traduce de inmediato en cambio estructural, y que la organización entre escalas es condición necesaria para que las intensificaciones locales produzcan efectos globales. Sin embargo, presenta limitaciones claras: en el huracán la organización depende de procesos físicos y energéticos, mientras que en el presente la coherencia es esencialmente relacional. Además, el huracán sigue un ciclo de vida definido, en contraste con el presente de las capas superiores, cuyo posible patrón de consolidación, madurez o eventual fragmentación permanece por determinar.

\subsection{Preguntas abiertas}

La caracterización del presente en capas jerárquicas y el papel regulador de la antisincronización plantean varias preguntas precisas que el marco actual no resuelve:
