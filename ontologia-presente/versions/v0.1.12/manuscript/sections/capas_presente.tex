...
\end{tikzpicture}
\shorthandon{><}%
\caption{Esquema jerárquico de las tres capas del presente. La antisincronización regula la permeabilidad entre capas mediante filtrado probabilístico bidireccional (ascendente y descendente). Cada capa introduce propiedades relacionales o globales nuevas e irreductibles.}
\label{fig:capas}
\end{figure}