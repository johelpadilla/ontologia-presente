...
- Always recompile LaTeX (full 4-pass: clean aux/bbl + pdflatex + bibtex + 2×pdflatex) after content changes affecting citations or structure.
- This paper is a focused outgrowth of the RECD + Ontología del Presente program.

## Current Status
See `CHANGELOG.md` for the latest entry.

Initial iteration (2026-06-18): structure creation + refined outline + abstract draft + key definitions list.
