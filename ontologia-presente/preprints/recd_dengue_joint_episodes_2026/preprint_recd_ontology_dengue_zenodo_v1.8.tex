% =============================================================================
% preprint_recd_ontology_dengue_zenodo_v1.8.tex
...
% =============================================================================
%
% Version History (v1.8, 17 June 2026)
% - Verified and corrected DOIs/Zenodo persistent identifiers for all references
%   authored by Johel Padilla-Villanueva. Updated padilla2026tau to include the
%   declared identifier 10.5281/zenodo.19654897 (Síntesis Magna version). Confirmed
%   and retained padilla2026permeability as 10.5281/zenodo.20723966 (as declared in
%   source document). tau2026 remains the project technical-reports placeholder.
% - Introduced \doi{} LaTeX helper (and consistent formatting) so that all DOIs
%   render as clean, visible, clickable text in the compiled PDF.
% - Performed critical assessment of the reference list against the paper’s core
%   claims (mathematical characterization of the three ontological layers; RQA
%   operationalization; Tau Sistémico/RECD foundations; EWS context). Marwan (2007)
%   and Scheffer et al. (2009) adequately ground the methods; the two Padilla-Villanueva
%   2026 entries (now with proper persistent identifiers) directly support the
%   paradigm and the permeability hypothesis that underpins layer characterization.
%   No additional references were required; the list is sufficient and appropriately
%   minimal.
% - Refined tone, precision, and logical flow of the central ontological-mathematical
%   claim paragraphs in the Discussion. Strengthened rigor while avoiding overstatement
%   (qualifying scope to the controlled synthetic validation and empirical results
%   presented). Minor polish to related sentences in Abstract and Letter.
% - Minor language and paragraph-flow improvements in denser sections of Results
%   and Discussion.
% - Updated all version strings, headers, footers, PDF metadata, and the Version
%   History block to v1.8.
% - Confirmed clean two-pass pdflatex compilation; verified visible rendering of
%   DOIs in bibliography and absence of new typographic issues.
% =============================================================================
...
\hypersetup{
    ...
    pdftitle={Mathematical Characterization of a Three-Layer Ontological Framework for Dengue Early Warning (v1.8)},
...
% DOI helper for clean, visible, clickable bibliography entries
...
\fancyhead[R]{\footnotesize Preprint v1.8 -- Zenodo}
...
\title{\textbf{Mathematical Characterization of a Three-Layer Ontological Framework for Dengue Early Warning Using Joint Episodes}\\[0.35em]
\large From Recurrence to Reorganization: Demonstrating the Mathematical Operationalization of Ontological Layers through Recurrence Metrics, Joint Episode Detection, and Calibrated Confidence Scoring}
...
\date{17 June 2026 \\ \small Version 1.8 — Preprint for Zenodo}
...
\caption{Ontological contrast between dynamical regimes (synthetic data). Boxplots of Joint Score (log scale) and episode duration for synthetic Joint episodes, stratified by regime and by Layer 3 outcome. San Juan-like episodes are substantially longer and higher-intensity, with clear separation by outcome. Iquitos-like episodes are short and weak, showing minimal differentiation---consistent with intrinsically rare sustained Layer 2 states. This reveals that Iquitos-like settings instantiate a qualitatively distinct dynamical regime rather than a data-poor version of San Juan-like conditions.}
\label{fig:regimes}
\end{figure}
...
Performance of the ``Alto'' category under the recommended weight vector is presented in Figure~\ref{fig:alto}.
...
\bibitem{padilla2026tau}
Padilla-Villanueva, J. (2026). \textit{El Paradigma del Tau Sistémico y la Ley del Reloj Extramental Discreto en Sistemas Complejos} [Síntesis Magna]. Universidad de Puerto Rico, Recinto de Ciencias Médicas. \doi{10.5281/zenodo.19654897}

\bibitem{padilla2026permeability}
Padilla-Villanueva, J. (2026). Empirical Validation of the Ontological Permeability Hypothesis: Calibration of Upward Probabilistic Filtering in the Three-Layer Model of the Present in Complex Systems. Technical Report. \doi{10.5281/zenodo.20723966}
...
\vspace{0.6em}
\noindent\textit{Preprint deposited on Zenodo – June 2026. Version 1.8.}  
