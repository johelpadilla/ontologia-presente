...
- Performed a complete and exhaustive audit of every figure reference in both .md and .tex to eliminate the numbering inconsistency that persisted in v1.5.  
- Enforced definitive numbering with zero mismatches: Figure 1 (The Three-Layer Ontological Framework and the Joint Episode), Figure 2 (Ontological contrast between dynamical regimes (synthetic data)), Figure 3 (Calibration (reliability) diagram for the San Juan-like regime), Figure 4 (Performance of the “Alto” category under the recommended weight vector).  
- Added clear, natural in-text references immediately preceding each figure presentation (e.g., “illustrated in Figure 1”, “shown in Figure 2”, “The reliability ... is illustrated in Figure 3”, “Performance of the “Alto” category ... is presented in Figure 4”). Verified all running text, image alt texts, visible **Figure X.** captions (MD), and LaTeX \caption / \label / \ref commands are consistent.  
- Confirmed physical order of figures in source matches numbering; framework diagram is always Figure 1 (including around the former page-3 location).  
- Reviewed and rewrote all four figure captions for clarity, professionalism, concision, and elegance; each now embeds a short ontological interpretation. Removed redundant or awkward phrasing.  
- Improved flow between Discussion and Limitations with refined bridging sentences. Performed light language polish: shortened remaining long sentences and strengthened transitions while maintaining formal academic tone.  
- Updated version strings, headers, footers, PDF metadata, and Version History to 1.6. Fixed outdated footer version reference.  
- Verified LaTeX compiles cleanly (two passes) to professional PDF with no margin overflows, correct figure placement, and proper spacing. All cross-references resolve correctly.
...
*Preprint deposited on Zenodo – June 2026. Version 1.6. Author: Dr. Johel Padilla Villaunueva. This document consolidates work from Phases 1–8 of the RECD + Ontología del Presente (Tau Sistémico) project.*