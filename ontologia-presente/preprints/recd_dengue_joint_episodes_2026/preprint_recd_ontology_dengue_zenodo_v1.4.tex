% =============================================================================
% preprint_recd_ontology_dengue_zenodo_v1.4.tex
...
% =============================================================================
%
% Version History (v1.4, 17 June 2026)
% - Established strict final figure numbering: Figure 1 (framework), Figure 2 (regime contrast),
%   Figure 3 (calibration), Figure 4 (Alto performance); aligned all text references, alts,
%   captions, and \label/\ref across document.
% - Polished figure captions for concision, precision, and elegance with brief ontological
%   interpretations; removed redundancies; synchronized .md and .tex.
% - Added bridging sentences between end of Discussion and Limitations for natural flow.
% - Final language review: shortened dense sentences, improved transitions and clarity
%   throughout while preserving formal tone and meaning.
% - LaTeX refinements: version metadata updates, figure spacing/placement tuning,
%   targeted sloppypar and break controls for clean professional PDF (no overflows).
% - Ensured note on future References expansion after validation remains explicit.
% - Updated all headers, footers, \date, and identifiers to v1.4.
% =============================================================================
...
\hypersetup{
    ...
    pdftitle={RECD + Three-Layer Ontology for Early Warning of Dengue Outbreaks (v1.4)},
...
\fancyhead[R]{\footnotesize Preprint v1.4 -- Zenodo}
...
\date{17 June 2026 \\ \small Version 1.4 — Preprint for Zenodo}
...
\caption{Calibration (reliability) diagram for the San Juan-like regime. Observed Layer 3 transition frequency is plotted against binned mean predicted Confidence Score under the recommended weight vector. Points lie near the diagonal, indicating calibration quality with modest recoverable bias.}
...
\caption{Performance of the ``Alto'' category under the recommended weight vector in the San Juan-like regime. The high-confidence category concentrates episodes with elevated empirical Layer 3 transition rates. In the Iquitos-like regime virtually no episodes reached the ``Alto'' threshold, revealing regime-dependent expression of Layer 1 + Layer 2 conditions.}
\label{fig:alto}
\end{figure}
...
\vspace{0.6em}
\noindent\textit{Preprint deposited on Zenodo – June 2026. Version 1.4.}  
