% =============================================================================
% preprint_recd_ontology_dengue_zenodo_v1.6.tex
...
% =============================================================================
%
% Version History (v1.6, 17 June 2026)
% - Performed complete exhaustive audit of every figure mention to eliminate the
%   numbering inconsistency persisting in v1.5 (text vs. caption around framework
%   diagram, missing lead-in references for Figures 3 and 4).
% - Enforced definitive numbering with zero mismatches across running text,
%   captions, alt text, \caption/\label/\ref, and source order:
%   Figure 1 = Three-Layer Ontological Framework and the Joint Episode
%   Figure 2 = Ontological contrast between dynamical regimes (synthetic data)
%   Figure 3 = Calibration (reliability) diagram for the San Juan-like regime
%   Figure 4 = Performance of the “Alto” category under the recommended weight vector
% - Added explicit natural in-text references immediately before each figure
%   (framework, regimes, calibration, Alto). Confirmed framework is referenced
%   and captioned as Figure 1 on/around page 3 with no contradictions.
% - Rewrote all captions to be clear, professional, concise, elegant and to embed
%   short ontological interpretations. Removed redundancies.
% - Refined 1–2 bridging sentences Discussion → Limitations; light language polish
%   (shortened dense sentences, improved transitions).
% - Updated all version strings, headers, footers, \hypersetup pdftitle, fancyhdr,
%   and end-of-document footer to v1.6. Fixed stale version references.
% - Verified clean two-pass pdflatex compilation: no margin overflows, correct
%   sequential figure placement, all \ref resolve, professional spacing.
% =============================================================================
...
\hypersetup{
    ...
    pdftitle={RECD + Three-Layer Ontology for Early Warning of Dengue Outbreaks (v1.6)},
...
\fancyhead[R]{\footnotesize Preprint v1.6 -- Zenodo}
...
\date{17 June 2026 \\ \small Version 1.6 — Preprint for Zenodo}
...
\vspace{0.6em}
\noindent\textit{Preprint deposited on Zenodo – June 2026. Version 1.6.}  
