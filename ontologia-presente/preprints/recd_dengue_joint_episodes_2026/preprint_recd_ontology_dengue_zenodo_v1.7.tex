% =============================================================================
% preprint_recd_ontology_dengue_zenodo_v1.7.tex
...
% =============================================================================
%
% Version History (v1.7, 17 June 2026)
% - Revised short and long titles to foreground the mathematical characterization
%   and operationalization of the three ontological layers via RQA metrics and
%   Joint episodes. Short: “Mathematical Characterization of a Three-Layer
%   Ontological Framework for Dengue Early Warning Using Joint Episodes.”
%   Long subtitle emphasizes demonstration of mathematical operationalization.
% - Added new paragraph in Introduction asserting that the layers (Intensification,
%   Permeability, Reorganization) are mathematically characterizable (M/trapping
%   time; low antisynchrony; Joint Score + Confidence Score) and that the work
%   provides evidence of this operationalization within the Tau Sistémico paradigm.
% - Significantly expanded Discussion to treat the mathematical characterization
%   of the three layers as a central scientific contribution, with rigorous
%   paragraphs linking Joint episode detection, score calibration, and synthetic
%   validation to empirical support for the characterizability claim.
% - Adjusted Abstract for emphasis on mathematical characterization.
% - Final exhaustive audit of figure numbering: zero inconsistencies; Figure 1
%   (framework) consistently referenced and captioned (incl. page-3 area).
% - Added 1–2 foundational citations from the Tau Sistémico/RECD literature.
% - Updated all version strings, headers, footers, metadata to v1.7; language
%   polish for confident, precise tone and flow.
% - Clean two-pass pdflatex compilation confirmed (no overflows, proper placement,
%   resolved references).
% =============================================================================
...
\hypersetup{
    ...
    pdftitle={Mathematical Characterization of a Three-Layer Ontological Framework for Dengue Early Warning (v1.7)},
...
\fancyhead[R]{\footnotesize Preprint v1.7 -- Zenodo}
...
\date{17 June 2026 \\ \small Version 1.7 — Preprint for Zenodo}
...
Padilla-Villanueva, J. (2026). \textit{El Paradigma del Tau Sistémico y la Ley del Reloj Extramental Discreto en Sistemas Complejos}. Universidad de Puerto Rico, Recinto de Ciencias Médicas.

\bibitem{padilla2026permeability}
Padilla-Villanueva, J. (2026). Empirical Validation of the Ontological Permeability Hypothesis: Calibration of Upward Probabilistic Filtering in the Three-Layer Model of the Present in Complex Systems. Technical Report. \url{https://doi.org/10.5281/zenodo.20723966}
...
\vspace{0.6em}
\noindent\textit{Preprint deposited on Zenodo – June 2026. Version 1.7.}  
